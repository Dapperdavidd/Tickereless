...
contract UpgradeSellMarket {
    uint256 private constant BASE_SEPOLIA_CHAIN_ID = 84532;
    address private constant USDC = 0x036CbD53842c5426634e7929541eC2318f3dCF7e;
    address private constant OLD_MARKET = 0xd3F95357840737383e0b7AB2e2b13daEb3F0e83e;
    ...
    uint256 private constant INITIAL_SELL_LIQUIDITY = 5e6;
    ...
    function run() external returns (TickerlessMarket market) {
        ...
        vm.startBroadcast();
        market = new TickerlessMarket(USDC);
        ...
        if (!IERC20(USDC).transfer(address(market), INITIAL_SELL_LIQUIDITY)) {
